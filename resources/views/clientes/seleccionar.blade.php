...
@section('content')
    ...
    function copiar_celdas($documento,$nombre) {
        ...
        if (pwintype != "undefined") {
                ...
                //alert($documento);        
                parent.opener.document.getElementById("cliente_nombre").value  = $nombre;                
                //alert($nombre);                        
        ...
        <div>
            ...
            <div class="form-group row">
                            ...
                            <nav class="navbar navbar-light bg-light">
                                <form class="form-inline" method {{route('seleccionar_clientes')}} >
                    ...
                    @foreach($clientes as $cliente)
                        <tr>
                            ...
                            <td align="left" valign="top">&nbsp;
                                <a href="javascript:copiar_cerrar('{{ $cliente->documento }}','{{ $cliente->nombre }}');">{{ $cliente->documento }}</a>
                            </td>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{!! route('clientes.destroy', $cliente->id) !!}" accept-charset="UTF-8">
